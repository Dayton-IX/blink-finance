        ...
        <div>
           <h2 className="text-accentSecondary text-3xl ml-5 font-thin">Sign Up</h2>
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col mx-auto w-11/12 mt-5">
                ...
                <label className={`text-light-textSecondary dark:text-dark-textSecondary ml-4`} htmlFor="email">Confirm Password</label>
                <input onChange={(e) => setConfirmPassword(e.target.value)} type="password" className={`text-light-textMain dark:text-dark-textMain border-b border-light-textSecondary bg-transparent focus:outline-none px-2 w-5/6 mx-auto py-1 mb-5`} placeholder="confirm password" />
                <MainButton onClick={() => onSignUp()} className="px-20 mx-auto w-max" >Sign Up</MainButton>
            </form>
